...
const normalizationMap = {
  ...
  Q4: [2, 4, 6, 7, 11, 14, 16, 19, 21],
} as const;
const ansInfo = {
  A: {
    name: '乐群性',
    description: '高分端倾向热情、乐于交往；低分端倾向安静、审慎并偏好较少的社交接触。',
    range: '1/10',
  },
  B: {
    name: '聪慧性',
    description:
      '高分端表示在本问卷所含推理题上的作答表现较高，低分端表示该部分作答表现较低；受教育、语言和测验情境影响，不能等同于智力诊断。',
    range: '1/10',
  },
  C: {
    name: '稳定性',
    description: '高分端倾向情绪稳定、较能调节压力；低分端倾向情绪反应较敏感、易受压力影响。',
    range: '1/10',
  },
  E: {
    name: '恃强性',
    description: '高分端倾向独立主张、具有影响力；低分端倾向合作、谦让并较愿意配合他人。',
    range: '1/10',
  },
  F: {
    name: '兴奋性',
    description: '高分端倾向活泼、自发和富有表现力；低分端倾向严肃、克制和审慎。',
    range: '1/10',
  },
  G: {
    name: '有恒性',
    description: '高分端倾向遵循规则、重视责任；低分端倾向灵活变通、较少受既定规范约束。',
    range: '1/10',
  },
  H: {
    name: '敢为性',
    description: '高分端倾向社交大胆、主动尝试；低分端倾向谨慎含蓄、在陌生情境中较为保留。',
    range: '1/10',
  },
  I: {
    name: '敏感性',
    description: '高分端倾向感受细腻、重视情感体验；低分端倾向务实、客观并关注实际问题。',
    range: '1/10',
  },
  L: {
    name: '怀疑性',
    description: '高分端倾向警觉、审慎判断他人动机；低分端倾向信赖、接纳并易于合作。',
    range: '1/10',
  },
  M: {
    name: '幻想性',
    description: '高分端倾向想象丰富、关注内在观念；低分端倾向务实、关注现实与具体事务。',
    range: '1/10',
  },
  N: {
    name: '世故性',
    description: '高分端倾向讲究策略、注意社交分寸；低分端倾向坦率、自然并直接表达。',
    range: '1/10',
  },
  O: {
    name: '忧虑性',
    description: '高分端倾向自我审视、较易担忧；低分端倾向沉着、自信并较少忧虑。',
    range: '1/10',
  },
  Q1: {
    name: '实验性',
    description: '高分端倾向开放求新、检视既有做法；低分端倾向重视传统、偏好熟悉方式。',
    range: '1/10',
  },
  Q2: {
    name: '独立性',
    description: '高分端倾向独立决策、自主行动；低分端倾向参考群体意见、重视共同参与。',
    range: '1/10',
  },
  Q3: {
    name: '自律性',
    description: '高分端倾向有条理、自我约束；低分端倾向随性、灵活，对结构化要求较少。',
    range: '1/10',
  },
  Q4: {
    name: '紧张性',
    description: '高分端倾向紧迫、易感到张力；低分端倾向放松、耐心和平静。',
    range: '1/10',
  },
  X1: {
    name: '适应与焦虑性',
    description:
      '低分端倾向平静、对环境较感适应；高分端倾向警觉、紧张并较易体验不安。该因素反映人格维度，不用于焦虑障碍诊断。',
    range: '-1.3/12.2',
  },
  X2: {
    name: '内外向性',
    description: '低分端倾向内向、审慎并偏好独处；高分端倾向外向、活跃并乐于社交。',
    range: '-1.7/12.7',
  },
  X3: {
    name: '感情用事与安详机警性',
    description:
      '低分端倾向重视感受、敏感并审慎权衡；高分端倾向客观、果断并关注现实行动。两端代表不同风格，无优劣之分。',
    range: '-3.5/14.5',
  },
  X4: {
    name: '怯懦与果敢性',
    description: '低分端倾向体谅、配合并寻求共识；高分端倾向独立、果断并主动施加影响。',
    range: '-3.5/14.5',
  },
  Y1: {
    name: '心理健康者的人格因素',
    description: '传统计分公式形成的组合指标，仅反映相关人格因素配置，不等同于心理健康诊断。',
    range: '4/40',
  },
  Y2: {
    name: '专业而有成就者的人格因素',
    description: '传统计分公式形成的组合指标，仅供了解相关人格因素配置，不能预测或保证职业成就。',
    range: '10/100',
  },
  Y3: {
    name: '创造力强者的人格因素',
    description: '该值是按传统公式计算的加权原始分，并非标准分，也不能单独判定创造力。',
    range: '15/150',
  },
  Y4: {
    name: '在新环境中有成长能力的人格因素',
    description:
      '传统计分公式形成的组合指标，用于描述与新环境适应相关的人格因素配置，不能保证适应表现或成功。',
    range: '4/40',
  },
};
...
export const cat16pf: Scale = {
  id: 'cat16pf',
  name: '卡特尔十六种人格因素问卷 (16PF)',
  description:
    '卡特尔十六种人格因素问卷（16PF）由 Raymond B. Cattell 开创，并由 Maurice Tatsuoka、Herbert Eber 等共同发展，1949年首次出版，用于描述16项相对独立的人格特质，可应用于心理研究、咨询、教育与职业发展等情境。当前187题版本接近第四版 A/B 全本的旧版形式；不同版本、译本及人群常模不可混用，解释时应采用与实际版本匹配的常模。各人格维度反映不同倾向，本身没有优劣之分。',
  refer: [
    {
      title: 'Handbook for the Sixteen Personality Factor Questionnaire (16 PF)',
      url: 'https://lccn.loc.gov/70130807',
    },
  ],
  questions: [
    {
